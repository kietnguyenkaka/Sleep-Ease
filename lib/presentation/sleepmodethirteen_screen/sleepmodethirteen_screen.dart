import 'bloc/sleepmodethirteen_bloc.dart';
import 'models/sleepmodethirteen_model.dart';
...
class SleepmodethirteenScreen extends StatelessWidget {
  ...
  static Widget builder(BuildContext context) {
    return BlocProvider<SleepmodethirteenBloc>(
        create: (context) => SleepmodethirteenBloc(SleepmodethirteenState(
            sleepmodethirteenModelObj: SleepmodethirteenModel()))
          ..add(SleepmodethirteenInitialEvent()),
        child: SleepmodethirteenScreen());
  }

  @override
  Widget build(BuildContext context) {
    mediaQueryData = MediaQuery.of(context);
    return BlocBuilder<SleepmodethirteenBloc, SleepmodethirteenState>(
